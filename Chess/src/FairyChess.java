...
public class FairyChess {
	...
	static boolean SecA=true, SecBa=false, SecBb=false, SecC=false;
...
//            	System.out.println();
    ...
    public static void SecA (String line){
    	//run valid1C amd figure out...maybe use arrays you muppet
    	// check for non ints
    	//FIXED!!!!! (I think....)
...
//    	de.bug("pawn.Bcountstore-", pawn.Bcountstore);
...
//    	n = i+10-(p+d) n=total off on board, i = totoal alloc
    ...
    public static void SecC(String line){
    	String [] l = line.split(":");
//    	de.bug(l[0] + "-" + l[1] + "-" + l[2] + "-" + l[3], l.length);
